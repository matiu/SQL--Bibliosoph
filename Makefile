...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: 2.51' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : "2.51"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="2.51">' > $(DISTNAME).ppd
